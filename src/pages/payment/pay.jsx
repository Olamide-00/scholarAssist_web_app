      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-2 mb-6 px-4 py-2 text-gray-400 hover:text-white transition-colors"
          >
            <ArrowLeft size={16} />
            Back to Order
          </button>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Choose your preferred payment method to start your project
          </p>
        </motion.div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-white font-medium">
                    {new Date(orderDetails.deadline).toLocaleDateString('en-GB')}
                  </span>
                </div>
                ...
                >
                      ...
                      {Object.entries(cryptoAddresses).map(([coin, address]) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <code className="text-white text-xs font-mono bg-slate-800/50 px-2 py-1 rounded flex-1 truncate">
                              {address}
                            </code>
                            <button
                  ...
                  {selectedMethod === "wise" && (
                    <div className="bg-slate-700/50 rounded-lg p-6 text-center">
                      ...
                      <p className="text-white mb-4">
                        You will be redirected to Wise to complete your transfer.
                      </p>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className="w-full mt-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl flex items-center justify-center gap-2"
                  >
                    <Zap size={20} />
